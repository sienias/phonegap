...
parking.factory("parkingHttpFacade", function ($http) {
  var todos = [{ plate: "AAA9990", color: "Blue", entrance: new Date() },
      { plate: "AAA9991", color: "Blue", entrance: new Date() },
      { plate: "AAA9992", color: "Blue", entrance: new Date() } ];
